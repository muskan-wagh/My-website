    ...
    <section id="projects" className="mx-auto max-w-[1080px] px-6 pt-8 pb-12 md:pb-16">
      ...
      <article className="mt-6 overflow-hidden rounded-[14px] border border-[#232529] bg-[#151618]">
        <div className="p-6 md:p-8">
          ...
          <h3 className="mt-2 text-[24px] md:text-[28px] font-semibold tracking-[-0.03em] leading-none text-[#f2f2f3]">{featured.title}</h3>
          <p className="mt-1.5 text-[14px] font-medium tracking-[-0.01em] text-[#9aa0a6]">{featured.subtitle}</p>

          {/* visual area — placeholder for screenshot, kept typographic and minimal */}
          <div className="mt-6 aspect-[16/7] rounded-[10px] border border-[#1e2023] bg-[#0f1012] flex items-center justify-center">
            <span className="font-mono text-[11px] tracking-[0.08em] uppercase text-[#3a3f45]">Preview — add screenshot</span>
          </div>

          <p className="mt-6 text-[15.5px] leading-[1.65] text-[#9aa0a6] max-w-[680px]">{featured.description}</p>
          ...
          {featured.highlights.length > 0 && (
            <ul className="mt-4 space-y-1.5 max-w-[640px]">
